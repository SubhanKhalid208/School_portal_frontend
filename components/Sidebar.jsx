...
export default function Sidebar({ role, onCollapseChange }) {
  ...
  return (
    <>
      ...
      {/* ✅ FIXED SIDEBAR LOGIC BY MUHAMMAD AHMED */}
      <aside 
        className={`h-screen bg-[#161d2f] border-r border-gray-800 flex flex-col p-4 transition-all duration-300 sticky top-0 left-0 z-50 ${
          isMobile
            ? `fixed ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'}`
